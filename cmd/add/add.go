...
func NewCmd(cfg *config.Config) *cobra.Command {
	addCmd.Flags().StringVarP(&cfg.Flags.Title, "title", "T", "",
		"bookmark title")
	addCmd.Flags().StringVarP(&cfg.Flags.TagsStr, "tags", "t", "",
		"bookmark tags")
	addCmd.Flags().StringVarP(&cfg.DBName, "name", "n", config.MainDBName,
		"database name")

	_ = addCmd.Flags().MarkHidden("help")
